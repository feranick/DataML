...
class Conf():
    ...
    def __init__(self):
        self.appName = "MasterDataMaker"
        confFileName = "MasterDataMaker.ini"
    ...
    def readConfig(self,configFile):
        try:
            ...
            self.masterDataMakerDef = self.conf['Parameters']
            ...
            self.charCCols = eval(self.masterDataMakerDef['charCCols'])
            self.predRCol = eval(self.masterDataMakerDef['predRCol'])
            ...
            self.validRows = eval(self.masterDataMakerDef['validRows'])
            ...
            self.randomCols = eval(self.masterDataMakerDef['randomCols'])
